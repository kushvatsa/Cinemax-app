...
public class RatedAdapter extends CursorAdapter {

    public RatedAdapter(Context context, Cursor c, int flags) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String posterPath = cursor.getString(RatedFragment.COL_MOVIE_POSTER_PATH);
